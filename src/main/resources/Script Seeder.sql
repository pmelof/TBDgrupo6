...
INSERT INTO `serie` (`id_serie`,`emisor`,`fecha_fin`,`fecha_inicio`,`nombre`,`sinopsis`,`imagen`) VALUES (2,'AMC',0,2010,'The Walking Dead','Sheriff Deputy Rick Grimes wakes up from a coma to learn the world is in ruins, and must lead a group of survivors to stay alive.','https://mlstaticquic-a.akamaihd.net/the-walking-dead-posters-cine-60x40-afiches-todas-las-series-D_NQ_NP_688337-MLU25915375625_082017-F.jpg');
INSERT INTO `serie` (`id_serie`,`emisor`,`fecha_fin`,`fecha_inicio`,`nombre`,`sinopsis`,`imagen`) VALUES (3,'AMC',0,2015,'Better Call Saul','The trials and tribulations of criminal lawyer, Jimmy McGill, in the time leading up to establishing his strip-mall law office in Albuquerque, New Mexico.','https://3.bp.blogspot.com/-mLkIdaz06Fg/WL-MlJT6v3I/AAAAAAAAgJc/lGnruMjrFyk_Hzq5FXfu85upe_GfEX5UQCLcB/s00/Better_Call_Saul_Season_3_Official_Poster_JPosters.jpg');
INSERT INTO `serie` (`id_serie`,`emisor`,`fecha_fin`,`fecha_inicio`,`nombre`,`sinopsis`,`imagen`) VALUES (4,'AMC',0,2015,'Fear the Walking Dead','A Walking Dead spin-off, set in Los Angeles, following two families who must band together to survive the undead apocalypse.','http://images.amcnetworks.com/amctv.es/wp-content/uploads/2018/04/AF_FTWD_ES_POST_POSTERSPY.jpg');
INSERT INTO `serie` (`id_serie`,`emisor`,`fecha_fin`,`fecha_inicio`,`nombre`,`sinopsis`,`imagen`) VALUES (5,'NETFLIX',0,2016,'Stranger Things','When a young boy disappears, his mother, a police chief, and his friends must confront terrifying forces in order to get him back.','https://images-na.ssl-images-amazon.com/images/I/A1UCp3347XL._SL1500_.jpg');
INSERT INTO `serie` (`id_serie`,`emisor`,`fecha_fin`,`fecha_inicio`,`nombre`,`sinopsis`,`imagen`) VALUES (6,'NETFLIX',0,2015,'Lucifer','Lucifer Morningstar has decided he\'s had enough of being the dutiful servant in Hell and decides to spend some time on Earth to better understand humanity. He settles in Los Angeles - the City of Angels.','http://cdn.collider.com/wp-content/uploads/2019/05/lucifer-poster-03.jpg');
...
INSERT INTO `serie` (`id_serie`,`emisor`,`fecha_fin`,`fecha_inicio`,`nombre`,`sinopsis`,`imagen`) VALUES (8,'NETFLIX',0,2014,'BoJack Horseman','BoJack Horseman was the star of the hit TV show \"Horsin\' Around\" in the \'90s, now he\'s washed up, living in Hollywood, complaining about everything, and wearing colorful sweaters.','http://2.bp.blogspot.com/-K8wjIS67rQQ/VaPJ9n1HH5I/AAAAAAAAFfk/89whqjNdVbA/s00/BoJack_Horseman_Season_2_New_Official_Poster_b_JPosters.jpg');
...
INSERT INTO `serie` (`id_serie`,`emisor`,`fecha_fin`,`fecha_inicio`,`nombre`,`sinopsis`,`imagen`) VALUES (10,'HBO',2019,2011,'Game of Thrones','Nine noble families fight for control over the mythical lands of Westeros, while an ancient enemy returns after being dormant for thousands of years.','https://timedotcom.files.wordpress.com/2017/08/game-of-thrones-aftermath-poster.jpeg');
INSERT INTO `serie` (`id_serie`,`emisor`,`fecha_fin`,`fecha_inicio`,`nombre`,`sinopsis`,`imagen`) VALUES (11,'HBO',0,2016,'Westworld','Set at the intersection of the near future and the reimagined past, explore a world in which every human appetite can be indulged without consequence.','https://i.pinimg.com/originals/d9/1c/3b/d91c3b94b9f2fa599b1ebd7d6ba0acb9.jpg');
INSERT INTO `serie` (`id_serie`,`emisor`,`fecha_fin`,`fecha_inicio`,`nombre`,`sinopsis`,`imagen`) VALUES (12,'HBO',0,2014,'True Detective','Seasonal anthology series in which police investigations unearth the personal and professional secrets of those involved, both within and outside the law.','https://m.media-amazon.com/images/M/MV5BMTUwMGM2ZmYtZGEyZC00OWQyLWI2Y2QtMTdjYzMxZGJmNjhjXkEyXkFqcGdeQXVyNjU2ODM5MjU@._V1_.jpg');
