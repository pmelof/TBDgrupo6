...
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (1, 11, 4, 2, 5);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (2, 9, 0, 4, 5);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (3, 70, 7, 54, 9);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (4,105,7,8,90);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (5,250,70,80,100);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (6,915,7,8,900);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (7,177,79,8,90);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (8,107,7,8,91);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (9,34,17,8,9);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (10,116,74,32,10);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (11,54,17,18,19);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (12,345,73,82,190);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (13,164,67,58,39);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (14,165,72,84,9);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (15,264,87,88,89);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (16,114,7,8,99);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (17,145,32,80,33);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (18,105,7,8,90);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (19,84,67,8,9);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (20,91,7,8,76);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (21,54,37,8,9);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (22,86,73,8,5);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (23,55,37,8,10);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (24,85,70,8,7);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (25,182,7,88,87);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (26,158,78,68,12);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (27,161,45,18,98);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (28,77,40,28,9);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (29,203,70,83,50);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (30,102,71,23,8);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (31,65,7,8,50);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (32,75,7,8,60);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (33,45,7,8,30);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (34,106,7,8,91);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (35,24,7,8,9);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (36,169,7,82,80);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (37,172,7,84,81);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (38,155,57,8,90);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (39,178,77,8,93);
INSERT INTO `estadistica_tweet` (`id_estadistica_tweet`,`nro_tweets`, `nro_tweets_negativos`, `nro_tweets_neutros`, `nro_tweets_positivos`) VALUES (40,248,67,81,100);

INSERT INTO `serie` (`id_serie`,`emisor`,`fecha_fin`,`fecha_inicio`,`nombre`,`sinopsis`,`id_estadistica_tweet`) VALUES (1,'AMC',2013,2008,'Breaking Bad','A high school chemistry teacher diagnosed with inoperable lung cancer turns to manufacturing and selling methamphetamine in order to secure his family\'s future.',1);
INSERT INTO `serie` (`id_serie`,`emisor`,`fecha_fin`,`fecha_inicio`,`nombre`,`sinopsis`,`id_estadistica_tweet`) VALUES (2,'AMC',0,2010,'The Walking Dead','Sheriff Deputy Rick Grimes wakes up from a coma to learn the world is in ruins, and must lead a group of survivors to stay alive.',2);
INSERT INTO `serie` (`id_serie`,`emisor`,`fecha_fin`,`fecha_inicio`,`nombre`,`sinopsis`,`id_estadistica_tweet`) VALUES (3,'AMC',0,2015,'Better Call Saul','The trials and tribulations of criminal lawyer, Jimmy McGill, in the time leading up to establishing his strip-mall law office in Albuquerque, New Mexico.',3);
INSERT INTO `serie` (`id_serie`,`emisor`,`fecha_fin`,`fecha_inicio`,`nombre`,`sinopsis`,`id_estadistica_tweet`) VALUES (4,'AMC',0,2015,'Fear the Walking Dead','A Walking Dead spin-off, set in Los Angeles, following two families who must band together to survive the undead apocalypse.',4);
INSERT INTO `serie` (`id_serie`,`emisor`,`fecha_fin`,`fecha_inicio`,`nombre`,`sinopsis`,`id_estadistica_tweet`) VALUES (5,'NETFLIX',0,2016,'Stranger Things','When a young boy disappears, his mother, a police chief, and his friends must confront terrifying forces in order to get him back.',5);
INSERT INTO `serie` (`id_serie`,`emisor`,`fecha_fin`,`fecha_inicio`,`nombre`,`sinopsis`,`id_estadistica_tweet`) VALUES (6,'NETFLIX',0,2015,'Lucifer','Lucifer Morningstar has decided he\'s had enough of being the dutiful servant in Hell and decides to spend some time on Earth to better understand humanity. He settles in Los Angeles - the City of Angels.',6);
INSERT INTO `serie` (`id_serie`,`emisor`,`fecha_fin`,`fecha_inicio`,`nombre`,`sinopsis`,`id_estadistica_tweet`) VALUES (7,'NETFLIX',0,2017,'Dark','A family saga with a supernatural twist, set in a German town, where the disappearance of two young children exposes the relationships among four families.',7);
INSERT INTO `serie` (`id_serie`,`emisor`,`fecha_fin`,`fecha_inicio`,`nombre`,`sinopsis`,`id_estadistica_tweet`) VALUES (8,'NETFLIX',0,2014,'BoJack Horseman','BoJack Horseman was the star of the hit TV show \"Horsin\' Around\" in the \'90s, now he\'s washed up, living in Hollywood, complaining about everything, and wearing colorful sweaters.',8);
INSERT INTO `serie` (`id_serie`,`emisor`,`fecha_fin`,`fecha_inicio`,`nombre`,`sinopsis`,`id_estadistica_tweet`) VALUES (9,'HBO',2019,2019,'Chernobyl','In April 1986, an explosion at the Chernobyl nuclear power plant in the Union of Soviet Socialist Republics becomes one of the world\'s worst man-made catastrophes.',9);
INSERT INTO `serie` (`id_serie`,`emisor`,`fecha_fin`,`fecha_inicio`,`nombre`,`sinopsis`,`id_estadistica_tweet`) VALUES (10,'HBO',2019,2011,'Game of Thrones','Nine noble families fight for control over the mythical lands of Westeros, while an ancient enemy returns after being dormant for thousands of years.',10);
INSERT INTO `serie` (`id_serie`,`emisor`,`fecha_fin`,`fecha_inicio`,`nombre`,`sinopsis`,`id_estadistica_tweet`) VALUES (11,'HBO',0,2016,'Westworld','Set at the intersection of the near future and the reimagined past, explore a world in which every human appetite can be indulged without consequence.',11);
INSERT INTO `serie` (`id_serie`,`emisor`,`fecha_fin`,`fecha_inicio`,`nombre`,`sinopsis`,`id_estadistica_tweet`) VALUES (12,'HBO',0,2014,'True Detective','Seasonal anthology series in which police investigations unearth the personal and professional secrets of those involved, both within and outside the law.',12);
...
INSERT INTO `actor` (`id_actor`,`nombre`,`id_estadistica_tweet`) VALUES (1,'Bryan Cranston',13);
INSERT INTO `actor` (`id_actor`,`nombre`,`id_estadistica_tweet`) VALUES (2,'Anna Gunn',14);
INSERT INTO `actor` (`id_actor`,`nombre`,`id_estadistica_tweet`) VALUES (3,'Aaron Paul',15);
INSERT INTO `actor` (`id_actor`,`nombre`,`id_estadistica_tweet`) VALUES (4,'Dean Norris',16);
INSERT INTO `actor` (`id_actor`,`nombre`,`id_estadistica_tweet`) VALUES (5,'Norman Reedus',17);
INSERT INTO `actor` (`id_actor`,`nombre`,`id_estadistica_tweet`) VALUES (6,'Melissa McBride',18);
INSERT INTO `actor` (`id_actor`,`nombre`,`id_estadistica_tweet`) VALUES (7,'Andrew Lincoln',19);
INSERT INTO `actor` (`id_actor`,`nombre`,`id_estadistica_tweet`) VALUES (8,'Lauren Cohan',20);
INSERT INTO `actor` (`id_actor`,`nombre`,`id_estadistica_tweet`) VALUES (9,'Bob Odenkirk',21);
INSERT INTO `actor` (`id_actor`,`nombre`,`id_estadistica_tweet`) VALUES (10,'Jonathan Banks',22);
INSERT INTO `actor` (`id_actor`,`nombre`,`id_estadistica_tweet`) VALUES (11,'Rhea Seehorn',23);
INSERT INTO `actor` (`id_actor`,`nombre`,`id_estadistica_tweet`) VALUES (12,'Patrick Fabian',24);
INSERT INTO `actor` (`id_actor`,`nombre`,`id_estadistica_tweet`) VALUES (13,'Alycia Debnam-Carey',25);
INSERT INTO `actor` (`id_actor`,`nombre`,`id_estadistica_tweet`) VALUES (14,'Colman Domingo',26);
...
INSERT INTO `personaje` (`id_personaje`,`nombre`,`id_actor`,`id_serie`,`id_estadistica_tweet`) VALUES (1,'Walter White',1,1,27);
INSERT INTO `personaje` (`id_personaje`,`nombre`,`id_actor`,`id_serie`,`id_estadistica_tweet`) VALUES (2,'Skyler White',2,1,28);
INSERT INTO `personaje` (`id_personaje`,`nombre`,`id_actor`,`id_serie`,`id_estadistica_tweet`) VALUES (3,'Jesse Pinkman',3,1,29);
INSERT INTO `personaje` (`id_personaje`,`nombre`,`id_actor`,`id_serie`,`id_estadistica_tweet`) VALUES (4,'Hank Schrader',4,1,30);
INSERT INTO `personaje` (`id_personaje`,`nombre`,`id_actor`,`id_serie`,`id_estadistica_tweet`) VALUES (5,'Daryl Dixon',5,2,31);
INSERT INTO `personaje` (`id_personaje`,`nombre`,`id_actor`,`id_serie`,`id_estadistica_tweet`) VALUES (6,'Carol Peletier',6,2,32);
INSERT INTO `personaje` (`id_personaje`,`nombre`,`id_actor`,`id_serie`,`id_estadistica_tweet`) VALUES (7,'Rick Grimes',7,2,33);
INSERT INTO `personaje` (`id_personaje`,`nombre`,`id_actor`,`id_serie`,`id_estadistica_tweet`) VALUES (8,'Maggie Greene',8,2,34);
INSERT INTO `personaje` (`id_personaje`,`nombre`,`id_actor`,`id_serie`,`id_estadistica_tweet`) VALUES (9,'Saul Goodman',9,3,35);
INSERT INTO `personaje` (`id_personaje`,`nombre`,`id_actor`,`id_serie`,`id_estadistica_tweet`) VALUES (10,'Mike Ehrmantraut',10,3,36);
INSERT INTO `personaje` (`id_personaje`,`nombre`,`id_actor`,`id_serie`,`id_estadistica_tweet`) VALUES (11,'Kim Wexler',11,3,37);
INSERT INTO `personaje` (`id_personaje`,`nombre`,`id_actor`,`id_serie`,`id_estadistica_tweet`) VALUES (12,'Howard Hamlin',12,3,38);
INSERT INTO `personaje` (`id_personaje`,`nombre`,`id_actor`,`id_serie`,`id_estadistica_tweet`) VALUES (13,'Alicia Clark',13,4,39);
INSERT INTO `personaje` (`id_personaje`,`nombre`,`id_actor`,`id_serie`,`id_estadistica_tweet`) VALUES (14,'Victor Strand',14,4,40);
